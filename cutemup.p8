...
function create_bullet(_x,_y,_s,_a,_id)
	...
	local b = create_ent({}, id, {x=_x,y=_y,w=1,h=1}, {
		dx=dx, --dx
		dy=dy, --dy,
		a=1,
		mspd=_s,
	...
	local r = create_timer(function()
		...
		while btn(4, p.pid) do
			...
			if i>=p.shtdelay then
				...
				create_bullet(p.chx, p.chy,2,aget(p.pos.x+3.5, p.pos.y+3.5,p.chx,p.chy)+rnd(0.035)-rnd(0.035))
				yield()
			end
			yield()
		end
...

