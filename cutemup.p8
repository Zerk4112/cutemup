...
function player_damframes(p, _f, _b)
	local f = _f or 10
	local blink = _b or true
	p.invinframes = create_timer(function()
		for i=1,f do
			if (blink) p.blink = not p.blink yields(5)
			yield()
		end
		p.blink=false
		del(routines,p.invinframes)
...
030c00200c0533f61414655000003f5150c053146553f5150c0533f515146550c0533f5150c0533f515146550c0533f51514655000000c0533f515146553f5150c05300000146553f5150c0530c053146553f515
