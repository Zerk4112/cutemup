...
function init_mapper()
	...
	main.coll_box = cmpnt_new_coll_box(0, 0, 4*8, 4*8, function()
		main.color=9
		-- printh('set color to 9')
	end)
	local helper = {
		pos = {
			x = camx+64,
	...
	add(ments, main)
	mdraw = create_timer(draw_stage_map,1,true)
	mupdate = create_timer(update_stage_map,1,true)
	add(aroutines, mdraw)
	add(routines, mupdate)
end

function update_stage_map()
	for m in all(ments) do
		sys_ent__update_coll(m)
		m:coll_check()
	end
end

function draw_stage_map()
	for m in all(ments) do
		rect(m.pos.x, m.pos.y, m.pos.x+(m.w*8),m.pos.y+(m.h*8), m.color)
		-- sys_ent__draw_coll(m.coll_box)
	end
end
...
function draw_stage1()
	...
	for i, p in pairs(entities) do
		if (p.act)sys_ent__draw_coll(p.coll_box)
	end
end
...

...
__gff__

